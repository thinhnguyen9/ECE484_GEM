...
class LaneNetDetector:
    ...
    def __init__(self, path_to_weights='../../../weights/yolopv2.pt'):
        ...
        self.turning_time = 0
        rospy.Subscriber("/perception/obstacle_if_side", Int32MultiArray, self.obs_detect_callback) # uncomment this line if you want to test obstacle avoidance
        ...
        if self.is_front_obs and self.is_in_avoidence==0:
            ...
            while self.is_front_obs:
                if turn_dir == 'left':
                    ...
                    curve_1=curve[:len(curve)/2]  # extract the first half
